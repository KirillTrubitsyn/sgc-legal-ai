...
async def stage_1_gather_opinions(question: str) -> Dict[str, Any]:
    ...
    """
    system_prompt = """Вы — эксперт-юрист по российскому праву.
Дайте развёрнутый ответ на юридический вопрос.

ВАЖНЫЕ ТРЕБОВАНИЯ К ФОРМАТИРОВАНИЮ:
- Пишите обычным текстом БЕЗ markdown-разметки
- НЕ используйте символы #, ##, ###, **, __, |, --- и таблицы
- Прямые цитаты из судебных решений или нормативных актов выделяйте курсивом: *цитата*
- Структурируйте текст абзацами и нумерованными списками (1. 2. 3.)

Если уместно, ссылайтесь на конкретные судебные дела с указанием:
- Номера дела (например, А40-12345/2024)
- Суда
- Даты решения
- Краткой сути позиции суда
...
- НЕ используй символы #, ##, ###, **, __, |, --- и таблицы
- Прямые цитаты из судебных решений или нормативных актов выделяй курсивом: *цитата*
- Структурируй текст абзацами и нумерованными списками (1. 2. 3.)
