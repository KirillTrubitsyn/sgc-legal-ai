...
# Заблокированные домены (пусто - все разрешены)
BLOCKED_DOMAINS = []
...
async def async_google_search(
    ...
    system_prompt = """Ты - поисковый помощник для юридических запросов. Найди информацию в интернете.
...
1. СУДЕБНАЯ ПРАКТИКА - решения судов, судебные акты
   Источники: sudact.ru, kad.arbitr.ru, consultant.ru, garant.ru, vsrf.ru, arbitr.ru

2. ЗАКОНОДАТЕЛЬСТВО - законы, кодексы, нормативные акты
   Источники: consultant.ru, garant.ru, pravo.gov.ru
